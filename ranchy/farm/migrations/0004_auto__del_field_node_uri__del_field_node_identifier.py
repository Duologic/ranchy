...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Node.uri'
        db.delete_column(u'farm_node', 'uri')

        # Deleting field 'Node.identifier'
        db.delete_column(u'farm_node', 'identifier')


    def backwards(self, orm):
        # Adding field 'Node.uri'
        db.add_column(u'farm_node', 'uri',
                      self.gf('django.db.models.fields.URLField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Node.identifier'
        raise RuntimeError("Cannot reverse this migration. 'Node.identifier' and its values cannot be restored.")
